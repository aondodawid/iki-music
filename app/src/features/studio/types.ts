...
export interface UiText {
  ...
  visualizerStateListening: string;
  visualizerStateStopped: string;
  visualizerStart: string;
  visualizerStop: string;
  visualizerRefreshSources: string;
  visualizerInputUnavailable: string;
  visualizerCaptureError: string;
  visualizer2dStyle: string;
  visualizerPalette: string;
  visualizerSensitivity: string;
  visualizerSmoothing: string;
  visualizerFftSize: string;
